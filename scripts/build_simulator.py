...
header { border-bottom:4px solid var(--red); padding:30px 0 18px; margin-bottom:24px; }
.kicker { font-family:Helvetica,Arial,sans-serif; text-transform:uppercase; letter-spacing:.13em; color:var(--red); font-size:.75rem; font-weight:700; }
h1 { font-size:2.1rem; margin:.2rem 0 .3rem; line-height:1.15; }
h2 { font-family:Helvetica,Arial,sans-serif; font-size:1.15rem; border-bottom:2px solid var(--line); padding-bottom:6px; margin:38px 0 14px; }
.deck { color:#333; max-width:820px; }
.note { font-family:Helvetica,Arial,sans-serif; font-size:.78rem; color:var(--muted); margin:6px 0 16px; }
.formula { font-family:Georgia,serif; background:#fff; border:1px solid var(--line); border-left:4px solid var(--red); padding:10px 14px; margin:12px 0; }
...
.party-input input[type=number] { width:110px; padding:4px 6px; border:1px solid #ccc; border-radius:4px; }
.party-input input[type=range] { width:100%; }
.toolbar { margin:14px 0; }
button { font-family:Helvetica,Arial,sans-serif; font-size:.8rem; padding:6px 12px; margin-right:8px; border:1px solid #ccc; background:#fff; border-radius:4px; cursor:pointer; }
button:hover { background:#f1eee8; }
...
th { background:#f1eee8; text-align:left; padding:7px 8px; border-bottom:2px solid var(--ink); font-size:.7rem; text-transform:uppercase; letter-spacing:.04em; }
td { padding:6px 8px; border-bottom:1px solid var(--line); vertical-align:top; }
tr:hover td { background:#faf6f0; }
.over { color:#b32424; font-weight:700; }
.under { color:#1a6a8a; }
...
footer { margin-top:46px; padding-top:14px; border-top:3px solid var(--ink); font-family:Helvetica,Arial,sans-serif; font-size:.74rem; color:var(--muted); }
@media (max-width:700px){ .party-input { grid-template-columns:16px 1fr 90px; } .party-input input[type=number]{ width:90px; } }
</style>
</head>
<body>
<div class="wrap">
...
<header>
  <div class="kicker">Interactive &middot; Morocco &middot; Chambre des Représentants</div>
